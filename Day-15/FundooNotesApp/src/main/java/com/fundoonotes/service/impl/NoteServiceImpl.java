...
public class NoteServiceImpl implements INoteService {
	...
	public NoteServiceImpl(NoteRepository noteRepository, UserRepository userRepository, NoteMapper noteMapper, TagRepository tagRepository) {
	...
	private Note getUserNote(Long noteId, Long userId) {
		...
		Note note = noteRepository.findByNoteIdAndOwner(noteId, owner)
						.orElseThrow(() -> new IllegalArgumentException("Note not found with this userId: " + userId));
